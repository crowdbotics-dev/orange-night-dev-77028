"""
Django settings for orange_night_dev_77028 project.
...
ROOT_URLCONF = 'orange_night_dev_77028.urls'
...
WSGI_APPLICATION = 'orange_night_dev_77028.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_night_dev_77028 API",
    "DESCRIPTION": "API documentation for orange_night_dev_77028 App",
    "VERSION": "v1",
}
